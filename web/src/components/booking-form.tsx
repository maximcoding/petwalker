...
/**
 * Initial address source — the first family the provider has opted in to,
 * picking the most-specific concrete source within that family. If the
 * provider somehow has nothing enabled (shouldn't happen — DB enforces
 * at-least-one), the picker hides itself and submission is blocked.
 */
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {supports ? (
        (() => {
          ...
          if (enabledCount === 1) {
            // Single supported source — render as a static label, no radio.
